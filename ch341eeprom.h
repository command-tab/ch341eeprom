...
enum ch341_speed_t {
    CH341_I2C_LOW_SPEED = 0,   // low speed - 20kHz
    CH341_I2C_STANDARD_SPEED = 1,      // standard speed - 100kHz
    CH341_I2C_FAST_SPEED = 2,  // fast speed - 400kHz
    CH341_I2C_HIGH_SPEED = 3,  // high speed - 750kHz
};
